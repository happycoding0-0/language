...
이 확장 프로그램은 크롬 확장 스토어 출시 전 입니다. 아래 방법으로 로컬에 설치하여 테스트할 수 있습니다.
...
'LLM - words (Lose My Mind)' 카드가 생성되면 설치 성공입니다.
